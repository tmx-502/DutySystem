                                ...
                                <div class=" navbar-collapse " id="sidebar-nav" style="overflow:auto;">
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li class="no">
                                            ...
                                            <ul class="submenu" >                                                        
                                                <li><a class="addUrl">历史值班</a></li>
                                                 <li><a onclick="EasyUi_AddTab('Page/theDuty.aspx')">本周值班</a></li>
                                            </ul>
                                        </li>
                                        <li class="no1">
...
<script type="text/javascript">    
    ...
    $(".addUrl").click(function () {
        var id = window.parent.location.search.replace('?id=', '');
        EasyUi_AddTab("Page/manageDutyShow.aspx?id="+id);
    });
