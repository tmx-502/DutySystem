...
(function($) {
	...
	$.fn.pagination.defaults = {
		...
		beforePageText: "Page",
		afterPageText: "of {pages}",
		displayMsg: "总记录数<font color='red'><b> 235688 </b></font>条"
	};
})(jQuery); (function($) {
	function _7d(_7e) {
		var _7f = $(_7e);
...
//			}
	...
	$.messager = {
	    show3: function (_20a) {
			...
			_20a || {});
	        var win = $("<div class=\"messager-body3\"></div>").html(opts.msg).appendTo("body");
	        win.window({
	            title: opts.title,
	            width: opts.width,
	            height: opts.height,
	    ...
	    show2: function (_20a) {
			...
			_20a || {});
	        var win = $("<div class=\"messager-body2\"></div>").html(opts.msg).appendTo("body");
	        win.window({
	            title: opts.title,
	            width: opts.width,
	            height: opts.height,
	...
	function _45b(_45c) {
		...
		var _462 = _45d.children("div.datagrid-header-inner").show();
		var _463 = _45d.width() - _45d.find("table").width(); //- opts.scrollbarSize table滚动条宽度
		var rate = _463 / _45e;
		if (!opts.showHeader) {
			_462.hide();
		}
